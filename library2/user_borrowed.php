            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <?php
							...
							AND borrow_book.borrowed_status = 'borrowed' $where order by borrow_book.borrow_book_id DESC") or die (mysqli_error($con));
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success"
                                        href="request_return.php<?php echo '?borrow_book_id='.$return_row['borrow_book_id']; ?>">
                                        Return
                                        Request</a>
                                </td>
                            </tr>
