  ...
  ?>
                        ...
                        <!---        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="number" value="<?php echo $row['university_number']; ?>" name="university_number" id="first-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
									<label class="control-label col-md-4" for="last-name">batch
									</label>
									<div class="col-md-4">
                                        <select name="batch" class="select2_single form-control" tabindex="-1" >
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="first-name">session
                                    </label>
                                    <div class="col-md-3">
                                        <input type="text" name="session" value="<?php echo $row['session']; ?>" placeholder="session....." id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
...
// mysqli_query($con," UPDATE user SET university_number='$university_number', firstname='$firstname', middlename='$middlename', lastname='$lastname', contact='$contact', 
// gender='$gender', address='$address', type='$type', batch='$batch', user_image='$still_profile' WHERE user_id = '$id' ")or die(mysqli_error());
...
{		
mysqli_query($con," UPDATE user SET university_number='$university_number', firstname='$firstname', middlename='$middlename', lastname='$lastname', contact='$contact', 
gender='$gender', address='$address', type='$type', batch='$batch', session='$session' WHERE user_id = '$id' ")or die(mysqli_error());
