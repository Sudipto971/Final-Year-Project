...
<head>
		<title>Library Management System BAUET</title>
...
<body>
	<div class = "container">
		<div id = "header">
		<br/>
		<img src = "images/uni.png" style = " margin-top:-17px; float:center; margin-left:800px; margin-bottom:-60px; width:100px; height:100px;">
				
				<center><h5 style = "font-style:Calibri"></h5>&nbsp; &nbsp;&nbsp;<strong><h2> Bangladesh Army University of Engineering & Technology </h2></strong> &nbsp;	&nbsp; </center>
				<center><h5 style = "font-style:Calibri; margin-top:-60px;"></h5> &nbsp; &nbsp; Library Managment System BAUET </center>
				<center><h5 style = "font-style:Calibri; margin-top:-14px;"></h5>Qadirabad,Natore</center>
...
?>
						<table class="table table-striped">
                                <div class="pull-left">
                                    <div class="span"><div class="alert alert-info"><i class="icon-credit-card icon-large"></i>&nbsp;Total Amount of Penalty:&nbsp;<?php echo "Taka ".$count_penalty_row['sum(book_penalty)'].".00"; ?></div></div>
                                </div>
								<br />
						  <thead>
								<tr>
...
?>
							<tr>
								...
								<td style="text-transform: capitalize; text-align:center;"><?php echo $return_row['batch']; ?></td>
								<td style="text-transform: capitalize; text-align:center;"><?php echo $return_row['session']; ?></td>
							...
							<!---	<td style="text-transform: capitalize"><?php // echo $return_row['author']; ?></td>
								...
								<?php
								 if ($return_row['book_penalty'] != 'No Penalty'){
									 echo "<td class='alert alert-warning' style='width:100px; text-align:center;'>Taka ".$return_row['book_penalty'].".00</td>";
								 }else {
