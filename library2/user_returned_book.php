            ...
            <div class="x_title">
                ...
                <form method="POST" action="returned_book_search.php" class="form-inline">
                    ...
                    <button type="submit" name="search" class="btn btn-primary btn-outline"><i
                            class="fa fa-calendar-o"></i> Search By Date Returned</button>
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <?php
                            ...
                            where user.user_id = '$user_session'") or die (mysqli_error($con));
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
                        ...
                        <div class="pull-left">
                            <div class="span">
                                <div class="alert alert-info"><i class="icon-credit-card icon-large"></i>&nbsp;Total
                                    Amount of
                                    Penalty:&nbsp;<?php echo "Taka ".$count_penalty_row['sum(book_penalty)'].".00"; ?>
                                </div>
                            </div>
                        </div>
...
?>
                            <tr>
                                ...
                                <?php
								 if ($return_row['book_penalty'] != 'No Penalty'){
									 echo "<td class='alert alert-warning' style='width:100px;'>Taka ".$return_row['book_penalty'].".00</td>";
								 }else {
