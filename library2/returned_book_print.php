...
<body>
	<div class = "container">
		<div id = "header">
		<br/>
		<img src = "images/uni.png" style = " margin-top:-17px; float:center; margin-left:615px; margin-bottom:-60px; width:100px; height:100px;">
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;"></h5>Qadirabad,Nator</center>
