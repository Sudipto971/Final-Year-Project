                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
						...
						<!---		<td>
								...
								<?php // endif; ?>
								</td>  either this <td><a target="_blank" href="view_members_barcode.php?code=<?php // echo $row['university_number']; ?>"><?php // echo $row['university_number']; ?></a></td> -->
								<td><a target="_blank" href="print_barcode_individual.php?code=<?php echo $row['university_number']; ?>"><?php echo $row['university_number']; ?></a></td> 
